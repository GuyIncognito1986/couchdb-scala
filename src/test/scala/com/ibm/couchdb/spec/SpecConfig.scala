...
object SpecConfig {
  ...
  val couchDbHost      = System.getProperty("couchDbHost", "192.168.0.200")
  ...
  val couchDbUsername  = System.getProperty("couchDbUsername", "root")
  val couchDbPassword  = System.getProperty("couchDbPassword", "Sha69roN")
